...
const assetAdvancedRoutes = require('./routes/asset-advanced')
const exceptionRuleRoutes = require('./routes/exception-rules')
...
app.use('/api/asset-advanced', assetAdvancedRoutes)
app.use('/api/exception-rules', exceptionRuleRoutes)
